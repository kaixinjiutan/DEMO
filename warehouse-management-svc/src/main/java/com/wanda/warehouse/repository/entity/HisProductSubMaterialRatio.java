...
@Entity
@Table(name = "HisProductSubMaterialRatio", indexes = {@Index(name = "u_his_product_sub_material_ratio",  columnList="", unique = true)})
//@Index(name = "i_company_activity", columnList = "activity_id,company_id") 联合索引
public class HisProductSubMaterialRatio {

	@Id
	@SequenceGenerator(name="seq_his_product_sub_material_ratio",allocationSize=1,initialValue=1, sequenceName="seq_his_product_sub_material_ratio_id") 
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="seq_his_product_sub_material_ratio") 
	...
	public String toString() {
		return "HisProductSubMaterialRatio [id=" + id + ", ProductCode=" + ProductCode + ", SubMaterialCode="
